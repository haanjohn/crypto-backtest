...
# Constants
COINGECKO_API_URL = "https://api.coingecko.com/api/v3/coins/{coin}/ohlc"

def fetch_historical_data(coin, days=365, currency="usd"):
    """
    Fetch OHLC historical market data from CoinGecko API.
    ...
    if response.status_code == 200:
        ...
        filename = f"{coin}_historical_ohlc.json"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python fetch_data_ohlc.py <coin_name> [days]")
        sys.exit(1)
